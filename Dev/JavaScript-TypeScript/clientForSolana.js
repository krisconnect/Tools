//WORK IN PROGRESS...It will be a modular client at one point hopefully...For now it is to work with: ```https://github.com/Unboxed-Software/solana-movie-program/tree/solution-add-comments```
import {
    Connection,
    Transaction,
    SystemProgram,
